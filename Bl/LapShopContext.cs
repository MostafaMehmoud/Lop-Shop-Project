...
using Bl; // Make sure this using directive is present
...
namespace Lap_Shop_Project.BL
{
    ...
    public partial class LapShopContext : IdentityDbContext<ApplicationUser>
    {
        ...
        //        => optionsBuilder.UseSqlServer("Server = DESKTOP-KADFQJ9\\SQL2022; Database = LapShop ; Trusted_Connection = true ;TrustServerCertificate=True");
